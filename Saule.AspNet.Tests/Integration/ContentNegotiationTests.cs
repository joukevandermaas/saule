...
namespace Saule.AspNet.Tests.Integration
{
    public class ContentNegotiationTests
    {
        ...
        public ContentNegotiationTests(ITestOutputHelper output)
        {
            _server = new JsonApiServer();
        }
        ...
        {
            return new StringContent(File.ReadAllText($"../../../../Saule.Common.Tests/Assets/{filename}"));
        }
    }
}
